...
function twentyseventeen_get_svg( $args = array() ) {
	...
	/*
	 * Puppys Playpen doesn't use the SVG title or description attributes; non-decorative icons are described with .screen-reader-text.
	 *
...
function twentyseventeen_social_links_icons() {
	...
	/**
	 * Filter Puppys Playpen social links icons.
	 *
