...
?>
	...
	<div class="site-footer-container">
		<footer id="footer" class="site-footer" role="contentinfo">&copy; <?php echo date('Y'); ?> Puppy's Playpen</footer>
	</div>
	...
	<!-- utility -->
	<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/utility.js"></script>
...
<?php if ( is_front_page() ) : ?>
  ...
  <script type="text/javascript">
	...
	<script>
		...
		var ticking = false;
		var inView = document.querySelector('[data-scrolled-to]');
		...
		window.addEventListener('scroll', function(e) {
			...
			if (!ticking) {
				...
				window.requestAnimationFrame(function() {
					if (isScrolledIntoView(inView)) {

						if (!inView.classList.contains('in-view')) {
...
<?php endif; ?>
	...
	<!-- instafeed -->
	<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/instafeed.js"></script>
